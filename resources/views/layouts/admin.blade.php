...
<h1 class="site-title"><a href="/"><img src="{{asset('images/logo-light.png')}}" alt=""> Trang chủ </a></h1>

<a href="#menu-toggle" class="btn" id="menu-toggle"><em class="fas fa-bars"></em></a>
<ul class="nav nav-pills flex-column sidebar-nav">
<li class="nav-item"><a class="nav-link {{Request::path()=="admin" ? 'active' : ''}}" href="/admin"><em class="fas fa-home"></em> Bảng điều khiển</a></li>
...
<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
        <header class="page-header row justify-center">
                ...
                <img src="{{asset('img/avatar.jpg')}}" alt="profile photo" class="circle float-left profile-photo" width="50" height="auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" style="margin-right: 1.5rem;" aria-labelledby="dropdownMenuLink"><a class="dropdown-item" href="#"><em class="fa fa-user-circle mr-1"></em> Xem thông tin</a>
