...
@endforeach
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <a href="{{url('/albums')}}" class="btn oneMusic-btn">Xem thêm <i class="fa fa-angle-double-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="newsletter-area mb-100">
                    ...
                    <div class="newsletter-form">
                        <form action="#" id="subscribeform">
                            ...
                            <button type="submit" class="btn oneMusic-btn">Đăng ký <i class="fa fa-angle-double-right"></i></button>
                        </form><br><br>
                    </div>
                </div>
            </div>
